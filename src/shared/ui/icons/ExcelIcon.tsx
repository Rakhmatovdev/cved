...
const ExcelSvg = (props: Partial<CustomIconComponentProps>) => (
  <svg
  ...
  >
    ...
    <path
      ...
      fill="url(#paint0_linear_12703_102101)"
    />
    ...
    <rect
      ...
      height="11.25"
      rx="2"
      fill="url(#paint1_linear_12703_102101)"
    />
    <path
...
export default function ExcelIcon(
  ...
  return <Icon component={ExcelSvg} {...props} />;
}
